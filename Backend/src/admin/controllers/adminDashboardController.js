    ...
    const statsSummary = [
      {
        ...
        change: activeProperties > 0 ? `${activeProperties} active` : '0 active',
        trend: 'up',
      ...
      },
      {
        ...
        change: `${totalOwners} hosts + ${totalTenants} tenants`,
        trend: 'up',
        color: 'text-blue-600',
        bgColor: 'bg-blue-100',
      },
      {
        ...
        change: pendingProperties > 0 ? `${pendingProperties} pending` : '0 pending',
        trend: 'up',
      ...
      },
      {
        ...
        change: `from ${activeProperties} listings`,
        trend: 'up',
