...
import { getVisit, removeVisitBooking } from "../utils/bookVisit";
                  ...
                  <div>
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-3">
                      ...
                      <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
                        ...
                        <p className="mt-3 text-[10px] uppercase tracking-wide text-white/50">
                          Date
                        </p>
